...
namespace LMMarsano.SumType {
	/**
	 * <summary>
	 * Extension methods for handling sum types.
	 * </summary>
	 */
	public static class Extension {
		 ...
		 * </summary>
		 * <param name="this">Value to cast to Maybe.</param>
		 ...
		 * <returns><see cref="Just{T}"/> current value if condition <c>true</c>, otherwise <see cref="Nothing{T}"/>.</returns>
		 */
		 ...
		 * </summary>
		 * <param name="this">Value to convert to Maybe.</param>
		 * <param name="predicate">Predicate over current value.</param>
		 * <typeparam name="T">Non-nullable.</typeparam>
		 * <returns><see cref="Just{T}"/> current value if predicate maps to <c>true</c>, otherwise <see cref="Nothing{T}"/>.</returns>
		 */
		 ...
		 * </summary>
		 * <param name="this">Enumerable to convert to Maybe.</param>
		 ...
		 * </summary>
		 * <param name="this">Sequence of values to optionally map.</param>
		 ...
		 * </summary>
		 * <param name="this">Dictionary with optional key.</param>
		 ...
		 * </summary>
		 * <param name="this">Disposable resource to manage.</param>
		 ...
		 * </summary>
		 * <param name="this">Value to convert.</param>
		 ...
		 */
		public static Result<Nothing> Try(this S.Action @this) => Factory.Try(@this);
		/**
		 * <summary>
		 * Evaluate to result.
		 * </summary>
		 * <returns>Result of successful evaluation (<see cref="Nothing"/>) or error.</returns>
		 */
		public static Result<Nothing> Try(this S.Action @this, S.Func<S.Exception, S.Exception> errorMap) => Factory.Try(@this, errorMap);
		/**
		 * <summary>
		 * Evaluate to result.
		 * </summary>
		 ...
		 */
		public static Result<T> Try<T>(this S.Func<T> @this) where T : object => Factory.Try(@this);
		/**
		 * <summary>
		 * Evaluate to result.
		 * </summary>
		 * <param name="this">Potential exception thrower.</param>
		...
		where T : object => Factory.Try(@this, errorMap);
		/**
		 * <summary>
